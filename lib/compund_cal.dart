...
import 'widgets/compound_calculator/add_new_compound.dart';

class CompoundCalculator extends StatefulWidget {
  @override
  _CompoundCalculatorState createState() => _CompoundCalculatorState();
}
            ...
            children: [
              PortfolioHeadingSection(
                ...
                widget: GestureDetector(
                    ...
                    onTap: () {
                      var data = Navigator.of(context).push(AddCompoundModal());
                    }
                ),
              ),
              SizedBox(
